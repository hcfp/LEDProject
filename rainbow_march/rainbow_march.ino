...
#define LED_COUNT 300      //Length of your LED strip
...
uint8_t  animation = 1;    //Active animation
uint8_t brightness = 50;    //Global brightness percentage

void setup()
{
  LEDS.addLeds<LED_TYPE, LED_PIN, COLOR_ORDER>(strip, NUM_LEDS).setCorrection(TypicalLEDStrip);
