...
float noise_fact[] = {
  ...
  1.7,
  3
}; // noise level determined by playing pink noise and seeing levels [trial and error]{204,188,68,73,150,98,88,68}
float noise_fact_adj[] = {
  15,
  7,
  1.5,
  1,
...
const uint8_t kMatrixHeight = 15; //----------was 27
...
void loop() {
  ...
  while (1) { // reduces jitter
    ...
    if (counter >= 50) {
      float master_volume = 1.4; // so the valu will be between ~0.5 and 1.---------------------+.75 was .5
